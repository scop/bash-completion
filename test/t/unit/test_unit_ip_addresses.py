...
class TestUnitIpAddresses:
    ...
    def test_4(self, functions, completion):
        """_comp_ip_addresses -6 should complete ipv6 addresses."""
        assert completion
        assert all(":" in x for x in completion)
